...
# $ManagementPath = 
$ManagementPath = 'C:\Program Files\Microsoft Dynamics NAV\100\Service\'
$ClientServicesCredentialType = "NavUserPassword"
$Server = "localhost"
$ServerInstance = "NAVSERVICE"
$ClientServicesPort = 7046
$DnsIdentity = "NAVSERVER"


Import-Module (Join-Path $ManagementPath "Microsoft.Dynamics.Nav.Management.dll") -CmdLet New-NavWebServerInstance
...
if ($DnsIdentity) 
{
    $arguments.Add("DnsIdentity",$DnsIdentity)
}

if ($AcsUri)
{
    $arguments.Add("AcsUri",$AcsUri)
}

New-NavWebServerInstance @arguments

# SIG # Begin signature block
# MIId0AYJKoZIhvcNAQcCoIIdwTCCHb0CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwuJjwcxZRmOVYL/fWdoRwgVt
# 9bOgghhlMIIEwzCCA6ugAwIBAgITMwAAAMhHIp2jDcrAWAAAAAAAyDANBgkqhkiG
...
# bW1qyVJzEw16UM0xggTVMIIE0QIBATCBlTB+MQswCQYDVQQGEwJVUzETMBEGA1UE
# CBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9z
# b2Z0IENvcnBvcmF0aW9uMSgwJgYDVQQDEx9NaWNyb3NvZnQgQ29kZSBTaWduaW5n
# IFBDQSAyMDExAhMzAAAAjoeRpFcaX8o+AAAAAACOMAkGBSsOAwIaBQCggekwGQYJ
# KoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwHAYKKwYBBAGCNwIBCzEOMAwGCisGAQQB
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFBkgSOIsxgAyLY63VCSe3bDcwetVMIGIBgor
# BgEEAYI3AgEMMXoweKBagFgATQBpAGMAcgBvAHMAbwBmAHQAIABEAHkAbgBhAG0A
# aQBjAHMAIABOAEEAVgAgAEMAbwBkAGUAcwBpAGcAbgAgAFMAdQBiAG0AaQBzAHMA
# cwBpAG8AbgAuoRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG9w0B
# AQEFAASCAQC2E/cJhMilHMo+8sflJxlpU9K5qnjn/DdjpyuWgGZSuXKmysT6lHgg
# iWwD+zKIbyFbVtv5c3Qhkejxuk1j+ecfhJLwHKdjKsDNhzJmtrf0VAMtyUBR2QL6
# UheoAdwMgJ0VKwbDd78Azb5sNUiGBCnOJ/GOb/VXbNywyCpPPddgSlD/l0CI3JE9
# AvFvHwNTehhPBuN/9Dpkj17Qjms7NthJrg7auzCx6dhNxazl2d3jkNvP1si8oqN8
# hIgtlDY4fyCbesrV/JnzRVyS4Y3Zi+ymxOoifWIDvuv7yfugubW70/KmXKMKQdNQ
# gGGAMdC34KQ8oaAYqRkMhbwULnYUhD6ZoYICKDCCAiQGCSqGSIb3DQEJBjGCAhUw
# ggIRAgEBMIGOMHcxCzAJBgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAw
# DgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9yYXRpb24x
# ITAfBgNVBAMTGE1pY3Jvc29mdCBUaW1lLVN0YW1wIFBDQQITMwAAAMhHIp2jDcrA
# WAAAAAAAyDAJBgUrDgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAc
# BgkqhkiG9w0BCQUxDxcNMTcwMTI4MDEwOTEwWjAjBgkqhkiG9w0BCQQxFgQUZGBP
# 8ha1nzzKkjkQhvxRj2JeJkEwDQYJKoZIhvcNAQEFBQAEggEAoKv+24k1sgTdGCvD
# Rl6pE1ZEVRaekNy03+Aae7nrkD2A0/3pDD3axOmoIPym7txt7kJ4R/nPLSftHSZF
# uzxfxvxYk64PpY6U04L8SFD1hG1YQUUyG0bmbgEE5EXntugSSKHP4jijzyLzN3hO
# PNf9eE8LJWQF+F6T0nLJY0bp3ztXy9T6rwX0DjvnUrwtjBNEtxYPnb9WTLO4pWcf
# oVuZc0qrMgAjmhGbyWNRA89hNNUnIlQW4Oh1ZmxKXdSNWOdvwYPcaMee3RJk4uN0
# 4aBlo/xvvfyuyJfFrc9+bH/qmdslEy9DHoqlnjNHVMMyBRh0NDpgkcfS20aoDC8f
# xYAWPQ==
